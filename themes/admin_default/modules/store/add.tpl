				...
				<div class="col-sm-16 col-md-16">
					<span id="getdistrict">	 
							<select  name="district_id" id="district" class="select">
								<option value="0">{LANG.post_select_area}</option>
								<!-- BEGIN: district -->					
								<option value="{DISTRICT.key}" {DISTRICT.selected}>{DISTRICT.name}</option>
								<!-- END: district -->
							</select>
			...
			<div class="form-group">
				...
				<div class="col-sm-16 col-md-16">
					<span id="getward"> 
								...
								<option value="0">{LANG.post_select_area}</option>
								<!-- BEGIN: ward -->					
								<option value="{WARD.key}" {WARD.selected}>{WARD.name}</option>
								<!-- END: ward -->
								</select>
                    ...
                    success: function(json) {       console.log( json['data']);
                        if( json['data'] )
                        {
                            ...
                            $.each(json['data'], function(key, item){
                                tmp+='<option value="'+ item['districtid'] +'">'+ item['title'] +'</option>';
                            });
                            $('#district').html( tmp );
                        }           
                    },
                    ...
                    console.log( json['sqlss']);
                        if( json['ward'] )
                        {
                            ...
                            $.each(json['ward'], function(key, item){
                                tmp+='<option value="'+ item['wardid'] +'">'+ item['title'] +'</option>';
                            });
                            $('#ward').html( tmp );
